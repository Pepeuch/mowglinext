...
![Dashboard overview](gui-walkthrough/screenshots/dashboard/01-overview.png)
...
![Dashboard with sensors expanded](gui-walkthrough/screenshots/dashboard/03-sensors-detail.png)
...
![Dashboard on mobile](gui-walkthrough/screenshots/mobile/01-dashboard.png)

The hero card and KPI tiles stack vertically; bottom tabs replace the sidebar.

### 2.2 Map page

![Map overview](gui-walkthrough/screenshots/map/01-map-overview.png)
...
![More menu](gui-walkthrough/screenshots/map/02-more-menu.png)
...
![Map in edit mode](gui-walkthrough/screenshots/map/03-edit-mode.png)
...
![Discard unsaved changes](gui-walkthrough/screenshots/map/04-save-confirmation-modal.png)
...
#### Step 0 — Welcome
![Welcome](gui-walkthrough/screenshots/onboarding/01-welcome.png)
Three info cards summarise what the wizard will do.

#### Step 1 — Robot Model
![Robot Model](gui-walkthrough/screenshots/onboarding/02-robot-model.png)
...
![GPS step](gui-walkthrough/screenshots/onboarding/03-gps.png)
...
#### Step 3 — Sensors
![Sensor placement](gui-walkthrough/screenshots/onboarding/04-sensors.png)
...
#### Step 4 — Firmware
![Firmware step](gui-walkthrough/screenshots/onboarding/05-firmware.png)
...
![Flash board](gui-walkthrough/screenshots/onboarding/06-flash-firmware.png)
...
![Localization tab](gui-walkthrough/screenshots/settings/04-localization.png)
...
![Diagnostics top](gui-walkthrough/screenshots/diagnostics/01-overview.png)
...
![Pose + GPS + Fusion Graph](gui-walkthrough/screenshots/diagnostics/02-pose-gps.png)
...
![Calibration panels](gui-walkthrough/screenshots/diagnostics/03-bt-coverage-network.png)
...
![ROS Diagnostics](gui-walkthrough/screenshots/diagnostics/04-imu-wheel-bottom.png)
...
![Schedule](gui-walkthrough/screenshots/schedule/01-overview.png)
...
![Logs](gui-walkthrough/screenshots/logs/01-overview.png)
...
![Statistics](gui-walkthrough/screenshots/statistics/01-overview.png)
