...
const hal_pin_t BOARD_HOME_BUTTON = {HOME_BUTTON_PORT, HOME_BUTTON_PIN};
const hal_pin_t BOARD_PERIMETER_COIL_A = {GPIOB, GPIO_PIN_8};
const hal_pin_t BOARD_PERIMETER_COIL_B = {GPIOB, GPIO_PIN_9};
