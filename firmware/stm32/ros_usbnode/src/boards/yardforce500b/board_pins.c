...
const hal_pin_t BOARD_DRIVE_RESET = {PAC5210RESET_GPIO_PORT, PAC5210RESET_PIN};
const hal_pin_t BOARD_BLADE_RESET = {PAC5223RESET_GPIO_PORT, PAC5223RESET_PIN};
const hal_pin_t BOARD_HALLSTOP_LEFT = {HALLSTOP_PORT, HALLSTOP_LEFT_PIN};
const hal_pin_t BOARD_HALLSTOP_RIGHT = {HALLSTOP_PORT, HALLSTOP_RIGHT_PIN};
